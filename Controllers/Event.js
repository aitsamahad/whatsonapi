...
const Token =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoxLCJ1c2VybmFtZSI6ImFpdHNhbSIsImVtYWlsIjoiYWl0c2FtQGlkZXZlbG9wc3R1ZGlvLmNvbSJ9LCJpYXQiOjE1ODMwNjg4MTJ9.YIr_GadGJEy-RrEYo956oTvxp5RUZf-d8YC4aUX79qw";
...
module.exports = {
  ...
  getInterestEvents: async (req, res) => {
    ...
    const events = await Event.find({ interest: interest })
      .populate(`days`, `day typesOfTicket`)
      .populate(`organizer`, `name`)
      .select(
        `images days currentBookings attendees title description address lat long happyHour food music offer generalInfo ticketDetails interest`
